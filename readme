...
В репозитории вы можете найти исходный код проекта `TapTaxi` реализованный на языке C#, С++ использующий следующие технологии `SQLEXPRESS`, `Entity Framework`, `LinQ запросы`, `Wforms`.
